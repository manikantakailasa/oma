...
<td align="right" valign="top" ><br>
    <table  align="center"  width="99%" style="padding-left:20px;">
        <tr>
            <td style="font-size:24px;">Search Blood Bank<br>
...
<% 
  ...
  rs=pt.executeQuery("select * from bloodbank where type like 'all' order by name");   
 while(rs.next()) 
  {  
...
out.println("<tr>");
out.println("<td><img src=bloodbanks/"+rs.getString(2)+" width=\"220\" height=\"150\" border=\"2\"></td><td align=\"left\" style=\"padding-left:30px;\">");
