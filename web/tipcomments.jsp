...
<table align="left" cellspacing="7"  > 
 ...
 <%
  ...
  rs=pt.executeQuery("select * from tips where id="+request.getParameter("qid")+"");
  ...
  out.println("<tr><td style=\"padding-left:10px;padding:3px;\" colspan=2><input class=\"comm\" type=\"button\" value=\"comment\" onclick=\" hnn("+rs.getInt(1)+")\"><span id=\"id"+rs.getString(1)+"\"></span> </td></tr>");
  out.println("</table></td></tr><tr><td height=\"20px\"></td></tr>");
  }  
  out.println("</table>");       
  rs=pt.executeQuery("select * from tipcomments where tid="+request.getParameter("qid")+" order by cid");    
  int g=0;
  while(rs.next())
  {  
  if(g==0)
  {
  out.println("<table width=\"96%\" align=\"right\" style=\"padding-bottom:10px;\"><tr><td align=\"left\" style=\"font-size:30px;padding-left:10px;box-shadow:0 0 2px black;color:red;\">comments</td></tr></table>");
  out.println("<table   width=\"96%\"  align=\"right\"  >");
  }   
  ...
  if(g==0)
  {
  out.println("<table width=\"96%\" align=\"right\" style=\"padding-bottom:10px;\"><tr><td align=\"left\" style=\"font-size:30px;padding-left:10px;box-shadow:0 0 2px black;\">no comments found</td></tr></table>");
  out.println("<table   width=\"96%\"  align=\"right\"  >");
  }    
   out.println("</table>");
  }
