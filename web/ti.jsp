...
window.location="ti.jsp";
   ...
   document.form.des.value="enter your tip here" ; 
   if(document.form.tipto.value=="")
   document.form.tipto.value="enter your tip title";
   if(document.form.tipto.value=="enter your tip title"||document.form.des.value=="enter your tip here")
   return false;
   return true;
   }    
   }
...
<table align="left" cellspacing="7"  > 
 ...
 <form action="addtip.jsp" method="post" onsubmit="return checkuser()" name="form">   
     <table align="right" style="box-shadow:0 0 2px black;padding-left:8px;" width="100%" >
     <tr><td colspan="3" style="font-size:23px; ">Add Your Tip:-</td></tr>
     <tr><td style="font-size:20px;width:10%;">Tip To</td><td><input type="text" style="height:30px;width:100%;border-radius:10px;font-size:15px;" name="tipto"></td></tr>
     <tr><td valign="top" style="font-size:20px;">Tip</td><td style="padding-left:0px;" valign="top"><textarea rows="4" cols="80" name="des" style="width:100%;border-radius:10px;font-size:16px;"></textarea></td>
         <td valign="top" style="padding-left:20px;padding-right:8px;" rowspan="2">
         <input type="submit" value="submit" class="addque">
         <br><br><br>
 ...
 <tr>
  ...
  rs=pt.executeQuery("select * from tips where cat like '%"+ck2[1].getValue()+"%' order by id desc");
  out.println("<table width=\"96%\" align=\"right\" style=\"padding-top:10px;padding-bottom:10px;\"><tr><td align=\"left\" style=\"font-size:30px;padding-left:10px;box-shadow:0 0 2px black;color:red;\">Related Tips</td></tr></table>");
  out.println("<table width=\"96%\"  align=\"right\"  >");
   while(rs.next())
   {  
  out.println("<form action=\"tipcomments.jsp\" method=\"post\"><tr><td style=\"box-shadow:0 0 2px black;height:100%;\">");
  out.println("<table width=\"100%\" style=\"font-size:20px;\" ><colgroup width=\"10%\"></colgroup>");
  out.println("<tr><td style=\"padding-left:10px;font-size:24px;\" colspan=2>#"+rs.getString(2)+"</td></tr>");
  out.println("<tr><td valign=top>Tip To:</td><td>"+rs.getString(3)+"</td></tr>");
  out.println("<tr><td valign=top>Tip:</td><td>"+rs.getString(4)+"</td></tr>");
  out.println("<tr><td style=\"padding-left:10px;padding:3px;\" colspan=2><input class=\"comm\" type=\"button\" value=\"comment\" onclick=\" hnn("+rs.getInt(1)+")\">&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"hidden\" value=\""+rs.getString(1)+"\" name=\"qid\"><input type=\"submit\" value=\"view comments\" class=\"comm\"></form><span id=\"id"+rs.getString(1)+"\"></span> </td></tr>");
